export const PRIMARY = '#F56F15';             // Oranye Utama (Header, Tab Aktif, Tombol)
export const ACCENT = '#FF3B30';              // Merah (Badge Keranjang)

// --- Warna Teks ---
export const TEXT_DARK = '#090909';           // Hitam (Default Teks)
...
export const SECONDARY_LIGHT = 'rgba(255, 255, 255, 0.8)'; // Latar Belakang Kontrol Bar (Meja/Keranjang)
export const CARD_BACKGROUND = 'rgba(255, 255, 255, 0.7)'; // Latar Belakang MenuCard Transparan
export const QUANTITY_BACKGROUND = 'rgba(0, 0, 0, 0.1)'; // Latar belakang Kontrol kuantitas
export const BORDER_LIGHT = 'rgba(255, 255, 255, 0.5)'; // Border Tab
